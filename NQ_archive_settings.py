...
def folder_public():
    ...
    try:
        ...
        folder_public = WebDriverWait(driver, 20).until(EC.presence_of_element_located((By.XPATH, "//*[@id='archive-tab-content']//span[contains(., '" + name_folder_admin + "')]")))
...
def transfer_company_approval():
    ...
    try:
        ...
        time.sleep(5)
        Commands.Selectbox_ByVisibleText(data["archive"]["admin"]["transfer"]["menu_approval"]["folders_option"], dept_key)
        ...
        ''' select language '''       
        Commands.Selectbox_ByVisibleText(data["archive"]["admin"]["transfer"]["menu_task"]["language_option"], language_key) 
...
def transfer_company_board():
    ...
    try:
        ...
        time.sleep(2)
        Commands.Selectbox_ByVisibleText(data["archive"]["admin"]["transfer"]["menu_board"]["board_option"], board_key)          
...
def transfer_company_task():
    ...
    try:
        ...
        Commands.Selectbox_ByVisibleText(data["archive"]["admin"]["transfer"]["menu_task"]["folders_option"], dept_key)     
        Logging("- Select Dept to transfer")
        time.sleep(2)
