...
def settings_execution():
    ...
    Logging("- Access menu")
    time.sleep(2)
    Commands.Wait10s_ClickElement(data["archive"]["setting"]["settings"])
    Logging("- Click setting")
    time.sleep(5)

    Logging(" ")
    PrintGreen("============ Test case settings Archive ============")
    Commands.Wait10s_ClickElement(data["archive"]["setting"]["manage_myarchive"])
...
def input_password():
    ...
    try:
        Commands.Wait10s_InputElement(data["archive"]["setting"]["pass"], password)
        Commands.Wait10s_ClickElement(data["archive"]["setting"]["button_submit"])
...
def add_folder():
    ...
    try:
        ...
        Commands.Wait10s_ClickElement(data["archive"]["setting"]["folder"])
        Logging("- Select folder")
        time.sleep(4)
        Commands.Wait10s_ClickElement(data["archive"]["setting"]["add_folder"])
        Logging("- Select my archive")
        time.sleep(2)
        Commands.Wait10s_ClickElement(data["archive"]["setting"]["enabled"])
        Logging("- Select Permission")
        time.sleep(2)
        Commands.Wait10s_InputElement(data["archive"]["setting"]["input_folder"], name_folder)
        Logging("- Input name folder")
        time.sleep(2)
        Commands.Wait10s_ClickElement(data["archive"]["setting"]["save"])
...
def edit_folder(name_folder):
    ...
    try:
        ...
        Commands.Wait10s_ClickElement("//*[@id='set-my-arch']//span[contains(., '" + name_folder + "')]")
        Commands.Wait10s_ClickElement(data["archive"]["setting"]["modify"])
        Logging("- Select edit folder")
        time.sleep(2)
        Commands.Wait10s_ClickElement(data["archive"]["setting"]["disabled"])
        Logging("- Edit Permission")
        time.sleep(2)
        Commands.Wait10s_Clear_InputElement(data["archive"]["setting"]["input_folder"], name_folder_edit)
...
def delete_folder(name_folder_edit):
    try:
        ...
        Commands.Wait10s_ClickElement("//*[@id='set-my-arch']//span[contains(., '" + name_folder_edit + "')]")
        Commands.Wait10s_ClickElement(data["archive"]["setting"]["delete"])
        time.sleep(2)
        Logging("- Select folder to delete - Click button delete")
        time.sleep(2)
        Commands.Wait10s_ClickElement(data["archive"]["setting"]["button_ok"])
...
def admin_execution():
    ...
    Commands.Wait10s_ClickElement(data["archive"]["admin"]["ManageCompany"]["Manage_Company"])
...
def folder_public():
    ...
    try:
        ...
        Waits.WaitElementLoaded(20, data["loading_dialog"])

        Commands.Wait10s_ClickElement(data["archive"]["admin"]["ManageCompany"]["parent_folder"])
        Logging("- Select folder to create")
        time.sleep(2)
        Commands.Wait10s_ClickElement(data["archive"]["admin"]["ManageCompany"]["add_folder_admin"])
        Logging("- Create folder")
        time.sleep(2)
        Commands.Wait10s_InputElement(data["archive"]["admin"]["ManageCompany"]["input_name_folder"], name_folder_admin)
        Logging("- Public folder")
        Logging("- Input name folder")
        time.sleep(2)
        Commands.Wait10s_ClickElement(data["archive"]["admin"]["ManageCompany"]["save_folder"])
        Logging("- Save public folder")
        time.sleep(3)
        Commands.Wait10s_ClickElement(data["archive"]["admin"]["ManageCompany"]["button_close"])
...
def folder_private():
    ...
    try:
        ...
        time.sleep(2)
        Commands.Wait10s_ClickElement(data["archive"]["admin"]["ManageCompany"]["disabled"])
        Logging("- Permission: disabled")
        time.sleep(2)
        Commands.Wait10s_InputElement(data["archive"]["admin"]["ManageCompany"]["input_name_folder"], name_folder_private)
        Logging("- Input name folder")
        time.sleep(2)
        Commands.Wait10s_ClickElement(data["archive"]["admin"]["ManageCompany"]["save_folder"])
...
def sub_folder(name_folder_admin):
    ...
    try:
        ...
        time.sleep(2)
        Commands.Wait10s_ClickElement(data["archive"]["admin"]["ManageCompany"]["add_subfolder"])
        Logging("- Add sub folder")
        time.sleep(2)
        Commands.Wait10s_InputElement(data["archive"]["admin"]["ManageCompany"]["input_subfolder"], name_subfolder)
        Logging("- Input name sub folder")
        time.sleep(2)
        Commands.Wait10s_ClickElement(data["archive"]["admin"]["ManageCompany"]["save_subfolder"])
...
def add_authorized_sub_folder(name_subfolder):
    ...
    try:
        ...
        Commands.Wait10s_ClickElement("//*[@id='archive-tab-content']//span[contains(., '" + name_subfolder + "')]")
        Logging("- Select sub folder")
        time.sleep(5)
        Commands.Wait10s_ClickElement(data["archive"]["admin"]["ManageCompany"]["Select_authorized_Dept."])
        Logging("- Select authorized Dept")
        time.sleep(2)
        Commands.Wait10s_ClickElement(data["archive"]["admin"]["ManageCompany"]["Dept."])
        Logging("- Select Dept.")
        time.sleep(2)
        Commands.Wait10s_ClickElement(data["archive"]["admin"]["ManageCompany"]["add_Dept."])
    ...
    try:
        ...
        Commands.Wait10s_ClickElement(data["archive"]["admin"]["ManageCompany"]["Include_Sub_Dept."])
        ...
        Logging("- Select Dept.")
        time.sleep(2)
        Commands.Wait10s_ClickElement(data["archive"]["admin"]["ManageCompany"]["Include_Sub_folder."])
...
def delete_sub_folder(name_subfolder):
    ...
    try:
        ...
        Commands.Wait10s_ClickElement("//*[@id='archive-tab-content']//span[contains(., '" + name_subfolder + "')]")
        time.sleep(3)
        Commands.Wait10s_ClickElement(data["archive"]["admin"]["ManageCompany"]["check_all"])
        time.sleep(3)
        Commands.Wait10s_ClickElement(data["archive"]["admin"]["ManageCompany"]["del_all"])
        time.sleep(3)
        Commands.Wait10s_ClickElement(data["archive"]["admin"]["ManageCompany"]["button_ok"])
        time.sleep(3)
        Logging("- Select sub folder")
        Commands.Wait10s_ClickElement(data["archive"]["admin"]["ManageCompany"]["del_folder"])
        time.sleep(3)
        Commands.Wait10s_ClickElement(data["archive"]["admin"]["ManageCompany"]["button_OK"])
...
def delete_public_folder(name_folder_admin):
    try:
        ...
        Commands.Wait10s_ClickElement("//*[@id='archive-tab-content']//span[contains(., '" + name_folder_admin + "')]")
        time.sleep(3)
...
def delete_private_folder(name_folder_private):
    try:
        ...
        Commands.Wait10s_ClickElement("//*[@id='archive-tab-content']//span[contains(., '" + name_folder_private + "')]")
        time.sleep(3)
        Logging("- Select parent folder")
        Commands.Wait10s_ClickElement(data["archive"]["admin"]["ManageCompany"]["del_folder"])
        time.sleep(3)
...
def archive_manager():
    ...
    Commands.Wait10s_ClickElement(data["archive"]["admin"]["ArchiveManager"]["Company_Archive"])
    time.sleep(5)
    Commands.Wait10s_ClickElement(data["archive"]["admin"]["ArchiveManager"]["Archive_Manager"])
    Logging("Access Archive_Manager")
    time.sleep(5)

    try:
        Commands.Wait10s_ClickElement(data["archive"]["admin"]["ArchiveManager"]["button_add"])
        Logging("- Add manager archive")
        time.sleep(5)

        Commands.Wait10s_EnterElement(data["archive"]["admin"]["ArchiveManager"]["input_name"], name_manager)
        Logging("- Input name manager archive")
        time.sleep(2)
        Commands.Wait10s_ClickElement(data["archive"]["admin"]["ArchiveManager"]["select_user"])
        Logging("- Select user")
        time.sleep(2)
        Commands.Wait10s_ClickElement(data["archive"]["admin"]["ArchiveManager"]["button_save"])
        time.sleep(2)
        Commands.Wait10s_ClickElement(data["archive"]["admin"]["ArchiveManager"]["button_OK."])
...
def delete_manager():
    ...
    try:
        ...
        Commands.Wait10s_ClickElement(data["archive"]["admin"]["ArchiveManager"]["pick_user"])
        Logging("- Select user to delete")
        time.sleep(5)
        Commands.Wait10s_ClickElement(data["archive"]["admin"]["ArchiveManager"]["button_delete"])
        Logging("- Click button delete")
        time.sleep(2)
        Commands.Wait10s_ClickElement(data["archive"]["admin"]["ArchiveManager"]["close_popup"])
...
def backup():
    ...
    Commands.Wait10s_ClickElement(data["archive"]["admin"]["backup_folder"]["menu"])
    ...
    try:    
        ...
        Commands.Wait10s_InputElement(data["archive"]["admin"]["backup_folder"]["input_name"], name_backup)
        Logging("- Input name backup")
        Commands.Wait10s_ClickElement(data["archive"]["admin"]["backup_folder"]["selectfolder"])
        time.sleep(2)
        Commands.Wait10s_ClickElement(data["archive"]["admin"]["backup_folder"]["choosefolder"])
        time.sleep(2)
        Logging("- Select folder to backup")
        Commands.Wait10s_ClickElement(data["archive"]["admin"]["backup_folder"]["click_date_range_from"])
        Commands.Wait10s_ClickElement(data["archive"]["admin"]["backup_folder"]["select_date_range_from"])
        time.sleep(2)
        Commands.Wait10s_ClickElement(data["archive"]["admin"]["backup_folder"]["click_date_range_to"])
        Commands.Wait10s_ClickElement(data["archive"]["admin"]["backup_folder"]["select_date_range_to"])
        time.sleep(2)
        Commands.Wait10s_ClickElement(data["archive"]["admin"]["backup_folder"]["save_backup"])
        Logging("- Save backup") 
        time.sleep(2)   
        Commands.Wait10s_ClickElement(data["archive"]["admin"]["backup_folder"]["close_popup"])
...
def transfer_company_approval():
    ...
    Commands.Wait10s_ClickElement(data["archive"]["admin"]["transfer"]["transfer_company"])
    Logging("- Transfer company")
    time.sleep(5)
    try:
        ''' select approval menu '''
        Commands.Wait10s_ClickElement(data["archive"]["admin"]["transfer"]["menu_approval"]["approval"])
        Logging("- Transfer company - Approval")
        time.sleep(5)
        Commands.Selectbox_ByVisibleText(data["archive"]["admin"]["transfer"]["menu_approval"]["folders_option"], "Selenium")
        Logging("- Select Dept to transfer")
        time.sleep(2)

        Commands.Wait10s_ClickElement(data["archive"]["admin"]["transfer"]["menu_approval"]["location_option"])
        time.sleep(3)
        Commands.Wait10s_ClickElement(data["archive"]["admin"]["transfer"]["menu_approval"]["location"])
        Logging("- Select location to transfer")
        time.sleep(2)

        ''' select language '''       
        Commands.Selectbox_ByVisibleText(data["archive"]["admin"]["transfer"]["menu_task"]["language_option"], "English") 
        Logging("- Select language")
        time.sleep(2)

        Commands.Wait10s_ClickElement(data["archive"]["admin"]["transfer"]["menu_approval"]["button_OK"])
        time.sleep(2)
        Commands.Wait10s_ClickElement(data["archive"]["admin"]["transfer"]["menu_approval"]["close_popup"])
        Logging("=> Transfer company - Approval")
        time.sleep(5)
...
def transfer_company_board():
    ...
    try:
        ...
        Commands.Wait10s_ClickElement(data["archive"]["admin"]["transfer"]["menu_board"]["company_board"])
        Logging("- Transfer company - Company Board")
        time.sleep(2)
        Commands.Selectbox_ByVisibleText(data["archive"]["admin"]["transfer"]["menu_board"]["board_option"], "Company Board")          
        Logging("- Select Company Board transfer")

        time.sleep(2)

        Commands.Wait10s_ClickElement(data["archive"]["admin"]["transfer"]["menu_board"]["location_option"])
        time.sleep(3)
        Commands.Wait10s_ClickElement(data["archive"]["admin"]["transfer"]["menu_board"]["location"])
        Logging("- Select location to transfer")
        time.sleep(2)
        ...
        Commands.Wait10s_ClickElement(data["archive"]["admin"]["transfer"]["menu_board"]["button_OK"])
        time.sleep(3)
        Commands.Wait10s_ClickElement(data["archive"]["admin"]["transfer"]["menu_board"]["close_popup"])
        Logging("=> Transfer company - Company Board")
...
def transfer_company_task():
    ...
    try:
        ...
        Commands.Selectbox_ByVisibleText(data["archive"]["admin"]["transfer"]["menu_task"]["folders_option"], "Selenium")     
        Logging("- Select Dept to transfer")
        time.sleep(2)

        Commands.Wait10s_ClickElement(data["archive"]["admin"]["transfer"]["menu_task"]["location_option"])
        time.sleep(3)
        Commands.Wait10s_ClickElement(data["archive"]["admin"]["transfer"]["menu_task"]["location"])
        Logging("- Select location to transfer")
        time.sleep(2)
        ...
        Commands.Wait10s_ClickElement(data["archive"]["admin"]["transfer"]["menu_task"]["button_OK"])
        time.sleep(3)
        Commands.Wait10s_ClickElement(data["archive"]["admin"]["transfer"]["menu_task"]["close_popup"])
