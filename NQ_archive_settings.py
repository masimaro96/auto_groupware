...
def folder_public():
    ...
    try:
        ...
        check_folder_public = WaitElementLoaded(20, "//*[@id='archive-tab-content']//span[contains(., '" + name_folder_admin + "')]")
...
def folder_private():
    ...
    try:
        ...
        check_folder_private = WaitElementLoaded(20, "//*[@id='archive-tab-content']//span[contains(., '" + name_folder_private + "')]")
