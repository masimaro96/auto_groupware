...
from NQ_login_function import driver, Logging, data
...
class Waits():
    ...
    def Wait20s_ElementInvisibility(xpath):
...
class Commands():
    ...
    def Wait20s_InputElement(xpath, value):
    ...
    def Wait20s_EnterElement(xpath, value):
        '''• Usage: Wait until the input box visible and send key value
            return WebElement'''
    ...
    def Wait20s_Clear_InputElement(xpath, value):
        '''• Usage: Wait until the input box visible and send key value
                return WebElement'''
    ...
    def Wait20s_Clear_Click_InputElement(xpath, value):
        '''• Usage: Wait until the input box visible and send key value
            return WebElement'''
    ...
    def Selectbox_By_Visible_Text(xpath, selected_text):
        '''• Usage: Wait until select box is loaded
                select by visible text, return select box
                visible text = str()'''
...
class Functions():
    ...
    def waitIf_ElementVisible(xpath):
        ...
        try:
            Waits.Wait20s_ElementLoaded(xpath)
            return True
        except WebDriverException:
            return False